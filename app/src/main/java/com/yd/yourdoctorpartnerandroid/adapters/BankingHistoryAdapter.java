    ...
    public class BankingHistoryViewHolder extends RecyclerView.ViewHolder {
        ...
        public void setData(ObjectBanking objectBanking) {
            ...
            if (objectBanking != null) {
                ...
                tvContentBanking.setText("Số tiền giao dịch: " + Utils.formatStringNumber(objectBanking.getAmount()) +"đ\nSố tiền hiện tại: " + Utils.formatStringNumber(objectBanking.getRemainMoney()) +"đ");
