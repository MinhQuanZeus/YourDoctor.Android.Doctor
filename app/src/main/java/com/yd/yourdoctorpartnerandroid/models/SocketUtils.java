...
public class SocketUtils {
    ...
    private static com.yd.yourdoctorpartnerandroid.utils.SocketUtils socketUtils;
    ...
    public static com.yd.yourdoctorpartnerandroid.utils.SocketUtils getInstance(){
        if(socketUtils == null){
            socketUtils = new com.yd.yourdoctorpartnerandroid.utils.SocketUtils();
        }
        return socketUtils;
    }
    ...
    public void reConnect(){
        ...
        com.yd.yourdoctorpartnerandroid.utils.SocketUtils.getInstance().getSocket().emit("addUser", SharedPrefs.getInstance().get("USER_INFO", Patient.class).getId());
    }
