...
public class Doctor {
    ...
    public Doctor(String phoneNumber, String password, String lastName, String firstName, String middleName, String birthday, String address, long remain_money, float currentRating, ArrayList<String> idSpecialist, String universityGraduate, int yearGraduate, String placeWorking) {
